...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Departamento',
            'route' => 'admin.departamento.index',
            'icon' => 'fas fa-fw fa-landmark',
            'active' => ['admin/departamento*'],
        ],
        [
            'text' => 'Provincia',
            'route' => 'admin.provincia.index',
            'icon' => 'fas fa-fw fa-compass',
            'active' => ['admin/provincia*'],
        ],
        [
            'text' => 'Municipio',
        ...
        [
            ...
            'active' => ['admin/gestion*'],
        ],
        [
            'text' => 'Solicitud Análisis',
            'route' => 'admin.solicitud_analisis.index',
